        ...
        <Container className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr]">
          <Card>
            ...
            <div className="mt-6 grid gap-4 text-anthracite/75">
              <a href={`tel:${contactInfo.phoneHref}`} className="flex items-center gap-3"><Phone size={18} /> {contactInfo.phone}</a>
              <a href={`mailto:${contactInfo.email}`} className="flex items-center gap-3"><Mail size={18} /> {contactInfo.email}</a>
              <a href={contactInfo.linkedin} className="flex items-center gap-3"><Linkedin size={18} /> LinkedIn</a>
