...
export function AboutPage() {
  return (
    <>
      <SEOHead title="Le Cabinet de Conseil RH & Coaching à Toulouse | ACT&RH" description="Parcours, vision et approche de Caroline Tillou Maratuech, consultante RH, coach professionnelle et docteure en gestion des ressources humaines." schema={personSchema} />
      <PageHeader eyebrow="À propos" title="Caroline Tillou Maratuech" text="Fondatrice d’ACT&RH, Caroline accompagne les transitions humaines, professionnelles et organisationnelles avec méthode, écoute et justesse." />
      <Section className="bg-white">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-start">
            <div className="prose-actrh max-w-none space-y-10">
              <div>
                <h2 className="font-serif text-3xl font-semibold text-ink border-b border-sage/20 pb-2 mb-4">Le cabinet ACT&RH</h2>
                <p className="text-lg leading-8 text-anthracite/80">
                  ACT&RH est un cabinet indépendant d'accompagnement et de conseil RH. 
                ...
                <p className="mt-4 text-base leading-7 text-anthracite/75">
                  ...
                  d'accompagnement du changement ou de bilans de compétences, ACT&RH place la clarté du cadre, la confiance réciproque et le respect 
              ...
              <div>
                ...
                <p className="text-lg leading-8 text-anthracite/80">
                  À la tête d'ACT&RH, Caroline Tillou Maratuech réunit une double expertise rare, 
